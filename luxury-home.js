(() => {
  ...
  const boot = (data) => {
    ...
    section.innerHTML = `
      ...
      <section class="luxury-path" aria-label="KISARAGI の入口"><p>KISARAGI / CATALOG PATH</p><div class="luxury-path-grid"><a href="./shop.html#catalog"><b>商品を選ぶ</b><span>画像・参考価格・状態を確認し、選択リストへまとめます。</span><i>SHOP →</i></a><a href="#jp-sku-catalog"><b>資料庫で探す</b><span>ブランド、商品名、品番から比較します。</span><i>ARCHIVE →</i></a><a href="./checkout.html#orderFunctions"><b>注文接続状況</b><span>会員、年齢確認、配送、支払い、注文、追跡の接続状況を確認します。</span><i>SERVICE STATUS →</i></a><a href="./trust.html"><b>運営・取引情報</b><span>現在利用できる機能と、正式運用前に公開する情報を確認します。</span><i>TRUST →</i></a><a href="./admin/"><b>商品管理</b><span>商品名、表示価格、商品画像を更新する管理サービスの接続状況を確認します。</span><i>ADMIN →</i></a></div></section>`;
