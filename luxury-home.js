  ...
  const boot = (data) => {
    ...
    section.innerHTML = `
      <section class="luxury-hero" aria-labelledby="luxury-title">
        ...
        <header class="luxury-nav"><a class="luxury-brand" href="./index.html">KISARAGI<small>RESEARCH ARCHIVE</small></a><nav class="luxury-links" aria-label="メインナビゲーション"><a href="./shop.html#catalog">商品案内</a><a href="#jp-sku-catalog">資料商品庫</a><a href="./shop.html#guide">利用案内</a></nav></header>
      ...
      <section class="luxury-path" aria-label="KISARAGI の入口"><p>KISARAGI / COLLECTION PATH</p><div class="luxury-path-grid"><a href="./shop.html#catalog"><b>商品を選ぶ</b><span>画像・参考価格・状態を確認し、選択リストへまとめます。</span><i>SHOP →</i></a><a href="#jp-sku-catalog"><b>資料から探す</b><span>ブランド、商品名、品番から比較します。</span><i>ARCHIVE →</i></a><a href="./shop.html#guide"><b>利用案内</b><span>年齢確認と選択リストの利用条件を確認します。</span><i>GUIDE →</i></a></div></section>`;
