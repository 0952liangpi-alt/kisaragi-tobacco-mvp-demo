...
const requiredChecks = [
  ...
  ['canonical product navigation', html, 'href="./shop.html#catalog">商品案内</a>'],
  ['shop navigation from home', html, 'href="./shop.html#catalog">商品案内</a>'],
  ['selection navigation from home', html, 'href="./checkout.html">選択リスト</a>'],
  ['guide navigation from home', html, 'href="./trust.html">利用案内</a>'],
  ['home navigation from shop', shop, 'href="./index.html">ホーム</a>'],
  ['archive mode remains in shop', shop, 'data-mode-target="archive"'],
  ['selection navigation from shop', shop, 'href="./checkout.html">選択リスト</a>'],
  ['guide navigation from shop', shop, 'href="./trust.html">利用案内</a>'],
  ...
  ['canonical catalog primary CTA', luxuryHome, 'href="./shop.html#catalog"'],
  ...
  ['home feature path links to selection', luxuryHome, 'href="./checkout.html"><b>選択リストを見る</b>'],
  ['mobile shop link to selection', shop, 'href="./checkout.html">選択</a>'],
  ...
  ['brand select', renderer, 'id="jp-sku-brand"'],
  ...
  ['mobile single-column catalog', catalogCss, /\.jp-sku-grid\s*\{\s*grid-template-columns:1fr/],
  ...
  ['home dock trust target', html, 'href="./trust.html">案内</a>'],
  ...
  ['four-column mobile dock', unifiedShell, 'grid-template-columns: repeat(4, minmax(0, 1fr))'],
